...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnDept30EmpsOrderedBySalaryDesc()
    {
        ...
        List<Emp> result = (emps.Where(e => e.Job == "DEPT 30").ToList()).OrderBy(e => e.Sal).ToList(); 
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = (from e in emps select new { e.EName, e.Sal }).ToList();
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.SelectMany(e => grades.Where(s => e.Sal >= s.Losal && e.Sal <= s.Hisal).Select(s => new { e.EName, s.Grade }));
