...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Min(e => e.Sal);
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts, e=> e.DeptNo, d => d.DeptNo, (e, d) => new {e, d}).SelectMany(x => grades.Where(s =>x.e.Sal >= s.Losal && x.e.Sal <= s.Hisal).Select(s => new { x.e.EName, x.d.DName, s.Grade})).ToList(); 
